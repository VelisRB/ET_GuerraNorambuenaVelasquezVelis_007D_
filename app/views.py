...
from .models import Cliente, DatosCliente, Producto
...
def ira(request):
    return render(request, 'app/ira.html')
...
def sale(request):
    ...
    return render(request, 'app/sale.html', datos)

def form_mod_prod(request,id):
    producto = Producto.objects.get(idProducto=id)

    datos = { 
        'producto': producto(instance=producto)
    }

    return render(request, 'app/form_mod_prod.html',datos)
